...
File: 05_procedure_types.do
Purpose: Summarise procedure types by MRC status and network.
...
collect export "$tables/proceduretype_by_mrc_network.xlsx", replace name(Table)