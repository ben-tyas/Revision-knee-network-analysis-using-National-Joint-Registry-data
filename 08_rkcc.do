...
File: 08_rkcc.do
Purpose: Summarise Revision Knee Complexity Classification (RKCC) grades.
...
table (year rkcc) (column_section column_member), ///
    statistic(frequency) ///
    statistic(percent, across(rkcc)) ///
    name(Table)
...
collect export "$tables/rkccv2.xlsx", replace name(Table)