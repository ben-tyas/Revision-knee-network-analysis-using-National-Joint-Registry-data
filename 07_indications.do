...
File: 07_indications.do
Purpose: Summarise indications for revision.
...
* Create table
*
* Rows: calendar year, then indications
...
table (year indication) (column_section column_member), ///
    statistic(frequency) ///
    statistic(percent, across(indication)) ///
    name(Table)
...
collect export "$tables/indicationsv2.xlsx", replace name(Table)